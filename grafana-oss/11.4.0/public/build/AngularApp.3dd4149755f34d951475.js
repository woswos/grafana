(self.webpackChunkgrafana=self.webpackChunkgrafana||[]).push([[8888],{83972:t=>{var s=`<div ng-transclude class="gf-form-query-content"></div>

`,a=s,e="public/app/angular/panel/partials/query_editor_row.html";window.angular.module("ng").run(["$templateCache",function(l){l.put(e,a)}]),t.exports=e},97654:t=>{var s=`<datasource-http-settings-next on-change="onChange" datasourceconfig="current" showaccessoptions="showAccessOption" defaulturl="suggestUrl" showforwardoauthidentityoption="showForwardOAuthIdentityOption" securesocksdsproxyenabled="secureSocksDSProxyEnabled">
`,a=s,e="public/app/angular/partials/http_settings_next.html";window.angular.module("ng").run(["$templateCache",function(l){l.put(e,a)}]),t.exports=e},35632:t=>{var s=`<div class="gf-form-group">
  <div class="gf-form">
...
`,a=s,e="public/app/angular/partials/tls_auth_settings.html";window.angular.module("ng").run(["$templateCache",function(l){l.put(e,a)}]),t.exports=e},75650:t=>{var s=`<page-header model="ctrl.navModel"></page-header>
...
<footer>
`,a=s,e="public/app/features/admin/partials/admin_home.html";window.angular.module("ng").run(["$templateCache",function(l){l.put(e,a)}]),t.exports=e},37724:t=>{var s=`<page-header model="navModel"></page-header>
...
<footer>
`,a=s,e="public/app/features/admin/partials/edit_org.html";window.angular.module("ng").run(["$templateCache",function(l){l.put(e,a)}]),t.exports=e},99894:t=>{var s=`<page-header model="ctrl.navModel"></page-header>
...
`,a=s,e="public/app/features/admin/partials/stats.html";window.angular.module("ng").run(["$templateCache",function(l){l.put(e,a)}]),t.exports=e},88430:t=>{var s=`<page-header model="ctrl.navModel"></page-header>
...
`,a=s,e="public/app/features/admin/partials/styleguide.html";window.angular.module("ng").run(["$templateCache",function(l){l.put(e,a)}]),t.exports=e},16304:t=>{var s=`
...
`,a=s,e="public/app/features/annotations/partials/event_editor.html";window.angular.module("ng").run(["$templateCache",function(l){l.put(e,a)}]),t.exports=e},15329:t=>{var s=`<div class="modal-body" ng-cloak>
...
`,a=s,e="public/app/partials/confirm_modal.html";window.angular.module("ng").run(["$templateCache",function(l){l.put(e,a)}]),t.exports=e},19122:t=>{var s=`<div class="modal-header">
...
</div>`,a=s,e="public/app/partials/modal.html";window.angular.module("ng").run(["$templateCache",function(l){l.put(e,a)}]),t.exports=e},84426:t=>{var s=`<page-header model="navModel"></page-header>
...
<footer>
`,a=s,e="public/app/partials/reset_password.html";window.angular.module("ng").run(["$templateCache",function(l){l.put(e,a)}]),t.exports=e},75463:t=>{var s=`<page-header model="navModel"></page-header>
...
<footer>
`,a=s,e="public/app/partials/signup_invited.html";window.angular.module("ng").run(["$templateCache",function(l){l.put(e,a)}]),t.exports=e},32638:t=>{var s=`<div class="editor-row">
...
`,a=s,e="public/app/plugins/panel/graph/axes_editor.html";window.angular.module("ng").run(["$templateCache",function(l){l.put(e,a)}]),t.exports=e},44443:t=>{var s=`<div class="gf-form-group">
...
`,a=s,e="public/app/plugins/panel/graph/tab_display.html";window.angular.module("ng").run(["$templateCache",function(l){l.put(e,a)}]),t.exports=e},22540:t=>{var s=`<div class="editor-row">
...
`,a=s,e="public/app/plugins/panel/graph/tab_legend.html";window.angular.module("ng").run(["$templateCache",function(l){l.put(e,a)}]),t.exports=e},97150:t=>{var s=`<div class="graph-series-override" ng-repeat="override in ctrl.panel.seriesOverrides" ng-controller="SeriesOverridesCtrl">
  <div class="gf-form">
...
`,a=s,e="public/app/plugins/panel/graph/tab_series_overrides.html";window.angular.module("ng").run(["$templateCache",function(l){l.put(e,a)}]),t.exports=e},52241:t=>{var s=`<graph-threshold-form panel-ctrl="ctrl"></graph-threshold-form>
`,a=s,e="public/app/plugins/panel/graph/tab_thresholds.html";window.angular.module("ng").run(["$templateCache",function(l){l.put(e,a)}]),t.exports=e},25558:t=>{var s=`<graph-time-region-form panel-ctrl="ctrl"></graph-time-region-form>
`,a=s,e="public/app/plugins/panel/graph/tab_time_regions.html";window.angular.module("ng").run(["$templateCache",function(l){l.put(e,a)}]),t.exports=e},56222:t=>{var s=`<div class="gf-form-group">
...
`,a=s,e="public/app/plugins/panel/graph/thresholds_form.html";window.angular.module("ng").run(["$templateCache",function(l){l.put(e,a)}]),t.exports=e},86987:t=>{var s=`<div class="gf-form-group">
...
`,a=s,e="public/app/plugins/panel/graph/time_regions_form.html";window.angular.module("ng").run(["$templateCache",function(l){l.put(e,a)}]),t.exports=e},14739:t=>{var s=`<div class="editor-row">
  <div class="section gf-form-group">
...
`,a=s,e="public/app/plugins/panel/heatmap/partials/axes_editor.html";window.angular.module("ng").run(["$templateCache",function(l){l.put(e,a)}]),t.exports=e},8468:t=>{var s=`<div class="editor-row">
  <div class="section gf-form-group">
...
`,a=s,e="public/app/plugins/panel/heatmap/partials/display_editor.html";window.angular.module("ng").run(["$templateCache",function(l){l.put(e,a)}]),t.exports=e},66214:t=>{var s=`<div class="edit-tab-content" ng-repeat="style in editor.panel.styles">
  <div class="gf-form-group">
    <h5 class="section-heading">Options</h5>
    <div class="gf-form-inline">
      <div class="gf-form gf-form--grow">
...
`,a=s,e="public/app/plugins/panel/table-old/column_options.html";window.angular.module("ng").run(["$templateCache",function(l){l.put(e,a)}]),t.exports=e},8896:t=>{var s=`<div class="gf-form-group">
  <div class="grafana-info-box">
...
`,a=s,e="public/app/plugins/panel/table-old/editor.html";window.angular.module("ng").run(["$templateCache",function(l){l.put(e,a)}]),t.exports=e},51645:t=>{var s=`<div class="table-panel-container">
...
`,a=s,e="public/app/plugins/panel/table-old/module.html";window.angular.module("ng").run(["$templateCache",function(l){l.put(e,a)}]),t.exports=e},12631:(t,s,a)=>{var e={"./angular/panel/partials/query_editor_row.html":83972,"./angular/partials/http_settings_next.html":97654,"./angular/partials/tls_auth_settings.html":35632,"./features/admin/partials/admin_home.html":75650,"./features/admin/partials/edit_org.html":37724,"./features/admin/partials/stats.html":99894,"./features/admin/partials/styleguide.html":88430,"./features/annotations/partials/event_editor.html":16304,"./partials/confirm_modal.html":15329,"./partials/modal.html":19122,"./partials/reset_password.html":84426,"./partials/signup_invited.html":75463,"./plugins/panel/graph/axes_editor.html":32638,"./plugins/panel/graph/tab_display.html":44443,"./plugins/panel/graph/tab_legend.html":22540,"./plugins/panel/graph/tab_series_overrides.html":97150,"./plugins/panel/graph/tab_thresholds.html":52241,"./plugins/panel/graph/tab_time_regions.html":25558,"./plugins/panel/graph/thresholds_form.html":56222,"./plugins/panel/graph/time_regions_form.html":86987,"./plugins/panel/heatmap/partials/axes_editor.html":14739,"./plugins/panel/heatmap/partials/display_editor.html":8468,"./plugins/panel/table-old/column_options.html":66214,"./plugins/panel/table-old/editor.html":8896,"./plugins/panel/table-old/module.html":51645,"app/angular/panel/partials/query_editor_row.html":83972,"app/angular/partials/http_settings_next.html":97654,"app/angular/partials/tls_auth_settings.html":35632,"app/features/admin/partials/admin_home.html":75650,"app/features/admin/partials/edit_org.html":37724,"app/features/admin/partials/stats.html":99894,"app/features/admin/partials/styleguide.html":88430,"app/features/annotations/partials/event_editor.html":16304,"app/partials/confirm_modal.html":15329,"app/partials/modal.html":19122,"app/partials/reset_password.html":84426,"app/partials/signup_invited.html":75463,"app/plugins/panel/graph/axes_editor.html":32638,"app/plugins/panel/graph/tab_display.html":44443,"app/plugins/panel/graph/tab_legend.html":22540,"app/plugins/panel/graph/tab_series_overrides.html":97150,"app/plugins/panel/graph/tab_thresholds.html":52241,"app/plugins/panel/graph/tab_time_regions.html":25558,"app/plugins/panel/graph/thresholds_form.html":56222,"app/plugins/panel/graph/time_regions_form.html":86987,"app/plugins/panel/heatmap/partials/axes_editor.html":14739,"app/plugins/panel/heatmap/partials/display_editor.html":8468,"app/plugins/panel/table-old/column_options.html":66214,"app/plugins/panel/table-old/editor.html":8896,"app/plugins/panel/table-old/module.html":51645};function l(r){var o=i(r);return a(o)}function i(r){if(!a.o(e,r)){var o=new Error("Cannot find module '"+r+"'");throw o.code="MODULE_NOT_FOUND",o}return e[r]}l.keys=function(){return Object.keys(e)},l.resolve=i,t.exports=l,l.id=12631}}]);

//# sourceMappingURL=AngularApp.3dd4149755f34d951475.js.map